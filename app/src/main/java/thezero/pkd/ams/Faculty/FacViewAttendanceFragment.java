 ...
 */
public class FacViewAttendanceFragment extends Fragment {
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private thezero.pkd.ams.Adapters.facHomeAdapter facHomeAdapter;
    private List <course_registered_model> course_registered_modelList;
    private RetrofitRoutesInterface retrofitRoutesInterface;
    private static String extraInfo="ViewAttendance";

    public FacViewAttendanceFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_fac_view_attendance, container, false);
        recyclerView=view.findViewById(R.id.view_all_RegisteredCourse);
